...
# 获取路径下的全部文件，列表形式
dirlist = os.listdir("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824")
print(type(dirlist))
print(dirlist)
...
#级联创建目录
# os.makedirs("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824/cuixd1/1/2")
...
path1 = "/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824"
# 判断是否是目录或者文件
...
# 获取文件的大小，单位是字节
path2 = "/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824/object_io.py"
...
#os.makedirs("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824/1/2/3")
...
list_dir("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20180824",0)
