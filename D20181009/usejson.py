...
with open("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20181009/info.json", "w") as f:
    # 进行导出，同样要指定ensure_ascii=False，
    json.dump(infodict, f, ensure_ascii=False)

# 将一个json文件加载到内存为字典类型
with open("/Users/cuixiaodong/PycharmProjects/PythonStudy/D20181009/info.json", "rb") as f:
    data = json.load(f)
    print(data)